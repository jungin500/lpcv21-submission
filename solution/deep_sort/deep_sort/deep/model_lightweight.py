...
class Net(nn.Module):
    def __init__(self, num_classes=751 ,reid=False):
        ...
        # 32 64 32
        self.layer2 = make_layers(32,48,2,True)
        # 64 32 16
        self.layer3 = make_layers(48,64,2,True)
        # 128 16 8
        self.layer4 = make_layers(64,128,2,True)
        # 256 8 4
...
if __name__ == '__main__':
    ...
    state_dict = torch.load('solution/deep_sort/deep_sort/deep/checkpoint/ckpt.t7', map_location=torch.device('cpu'))['net_dict']
